...
- Yi-Hsiang Wei: system-level design, transistor-level OTA design, and simulation analysis.
- Chun-Chi Lu: switched-capacitor SHA integration, clocking setup, and simulation verification.
- Zijian Shang: result analysis, figure preparation, and final report organization.
